        ...
        <div class="flex flex-wrap text-left lg:text-left ">
            <div class="w-full lg:w-6/12 px-4 ">
                ...
                <h5 class="text-lg mt-0 mb-2 text-blueGray-600">
                    Antar jemput pasien (dalam & luar kota), evakuasi pasien/Jenazah , stendby event, pelayanan kedukaan, formalin jenazah, kremasi, kargo jenazah via udara, jual beli peti berbagai kelas.
                </h5>
                <div class="mt-6 lg:mb-0 mb-6">
                    <button
                        class="hover:bg-white hover:bg-opacity-30 text-lightBlue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                        type="button">
                        <i class="fab fa-twitter"></i></button>
                    <button
                        class="hover:bg-white hover:bg-opacity-30 text-lightBlue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                        type="button">
                        <i class="fab fa-facebook-square"></i></button>
                    <button
                        class="hover:bg-white hover:bg-opacity-30 text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                        type="button">
                        <i class="fab fa-dribbble"></i></button>
                    <button
                        class="hover:bg-white hover:bg-opacity-30 text-blueGray-800 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                        type="button">
